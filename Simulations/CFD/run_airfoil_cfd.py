...
meaningful for fin selection (RQ3) and future control-vane work.

The angle sweep uses 0.5 deg increments -- the same deflection resolution as the
RQ3/RQ4 wind-tunnel campaign -- so the polars are directly comparable to tunnel data.
...
wind tunnel (RQ3/RQ4) and are what this code is meant to be validated against.
"""
import os, csv
import numpy as np
