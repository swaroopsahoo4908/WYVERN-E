...
ax.set_ylabel("torque (kg·cm)"); ax.set_title(f"WYVERN-E · gimbal torque need {Treq_kgcm:.2f} kg·cm (×2 SF) vs micro servos",fontweight='bold'); ax.grid(alpha=.3,axis='y'); sv(fig,"12_servo_sizing")
