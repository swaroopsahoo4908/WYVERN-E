...
## 1. Mass budget (recalculated — PETG-CF nose/engine, PLA body)

| Section | Items | Mass |
|---|---|---|
| Nose (PLA) | ellipsoid nose cone | 21 g |
| Recovery bay (PLA) | bay tube, chute+cord, Nomex protector, BNO085 (vote), **PETG-CF** bypass gas tube, **PETG-CF** sealed Bulkhead B, ejection plenum + nose retention | 137 g |
| FC bay (PLA) | bay tube, Pico 2 W, BNO085, baro (BMP/BME), µSD, i3 4K Thumb Action Camera, 2S LiPo + 5 V UBEC | 122 g |
| Engine/TVC bay (PETG-CF) | bay tube, Bulkhead A, gimbal assy, 2 servos, BNO085, motor mount | 268 g |
| Fins + wiring | 4× PLA fins (72 mm), wiring/connectors | 50 g |
| **Dry total** | | **690 g** |
| Motor | Estes F15-4 loaded (60 g propellant) | 102 g |
| **Liftoff** | | **792 g** |

*Material strategy: PLA is the main construction (nose, body, fins, FC/recovery bays); PETG-CF is reserved for the two bulkheads, the ejection bypass tube, and the engine assembly (engine/TVC bay + motor mount + gimbal).*

PLA (foamed, ~0.5–0.7 g/cm³) for the body cuts ~100–110 g vs PETG-CF (1.25 g/cm³); the original
812 g spec used a PETG-CF body. The lighter vehicle *raises* T/W and apogee (see §3–4).
...
Deploy is by the **F15-4 motor ejection charge**, fired 4 s after burnout at **t ≈ 7.45 s** (1.18 s past apogee), routed through the bypass tube into the recovery bay; the finned
...
the timer to ~5 s for ~20 m/s. An **24″ chute** gives terminal **~6 m/s**:
