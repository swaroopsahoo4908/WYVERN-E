// GTR70E WYVERN · T4 — BME680 (shared I2C bus, no mux) -> SPI microSD CSV @100Hz, custom PCB1.
// Matches the flight baro (baro.h): BME680 only, address 0x76 -- no BMP388 is populated on this
...
void setup(){ Serial.begin(115200);
  ...
  if(!bme.begin(0x76)) Serial.println("BME680 FAIL (0x76)");
