...
| 2 — Zoned AM materials | Three-point bend coupons + exhaust-plume jetvane erosion screen (§5.1, §5.4) | Lumped-capacitance thermal + first-order FEA margins, `WYVERN_E4_FEA_Structural.md` (§5.1) |
...
|---|---|---|---|
| 0 g (selected) | 72 mm | 705 g | ~429 ft |
